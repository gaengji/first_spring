...
class CommentRepositoryTest {
    ...
    void findByNickname() {
        ...
        /* Case2: "Kim"의 모든 댓글 조회 */
        {
            ...
            Comment b = new Comment(2L, new Article(4L,"당신의 인생 영화는?", "댓글 ㄱ"), nickname, "아이 엠 샘");
            Comment c = new Comment(2L, new Article(4L,"당신의 인생 영화는?", "댓글 ㄱ"), nickname, "아이 엠 샘");
